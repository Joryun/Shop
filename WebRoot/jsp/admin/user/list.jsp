				...
				<TBODY>
					...
					<tr align="center">
						<td colspan="7">
							...
							<c:if test="${page != 1 }">
								<a href="listUser/1">首页</a>|
								<a href="${ pageContext.request.contextPath }/listUser/<c:out value="${page - 1 }"/>">上一页</a>|
							</c:if>
							<c:if test="${page != count }">
								<a href="${ pageContext.request.contextPath }/listUser/<c:out value="${page + 1 }"/>">下一页</a>|
								<a href="${ pageContext.request.contextPath }/listUser/<c:out value="${count }"/>">尾页</a>|
							</c:if>
						</td>
					</tr>
				</TBODY>
