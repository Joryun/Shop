					...
					<dd>
						...
						%>
							...
							<c:if test="${currentTime ==  privilegeTime}">
								<strong>￥：<fmt:formatNumber type="number" minFractionDigits="1" value="${product.shop_price * product.categorySecond.category.discount } " maxFractionDigits="1" />元
								</strong>
								...
								<fmt:formatNumber var="price" type="number" value="${product.shop_price * product.categorySecond.category.discount }" maxFractionDigits="1" scope="application" />
								<%
							...
							<c:if test="${currentTime !=  privilegeTime}">
								<strong>￥：<fmt:formatNumber type="number" minFractionDigits="1" value="${product.shop_price }" maxFractionDigits="1" />元
								</strong>

								<%-- 传price变量到CartController，并给CartItem price赋值 --%>
								<fmt:formatNumber var="price" type="number" value="${product.shop_price }" maxFractionDigits="1" scope="application" />
								<%
									session.setAttribute("price", application.getAttribute("price"));
								%>
